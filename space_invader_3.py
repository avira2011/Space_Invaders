...
def draw():
    ...
    yellow_text = font.render('Health:'+ str(y_health), True, 'white')
    red_text = font.render('Health:' + str(r_health), True, 'white')
    gameover_text = font.render('Game Over', True, 'White')
    winner_text = font.render('Winner is ' + winner, True, 'White')
    screen.blit(yellow_text, (20,20))
    screen.blit(red_text, (670,20))
    if gameover == True:
        screen.blit(background, (0,0))
        screen.blit(gameover_text, (350,300))
        screen.blit(winner_text, (350, 500))
...
def game_over():
    global y_health, r_health, gameover, winner
    if y_health == 0:
        winner = 'red'
        gameover = True
    elif r_health == 0:
